...
#Supposing the following scripts are located in you directory  
readHexamer = "/your/directory/RSeQC-2.6.5/scripts/read_hexamer.py" # download RSeQC in http://rseqc.sourceforge.net
